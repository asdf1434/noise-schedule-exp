...
# ==========================================
# Q2 conditioning sweep: eurosat64 with --conditioning lowres, the same 6
...
# ==========================================
#SBATCH --job-name=eurosat64_lowres
...
#SBATCH --array=0-119
#SBATCH --output=logs/slurm/slurm_eurosat64_lowres_%A_%a.out
...
echo "========================================"
echo "Array task $IDX: dataset=eurosat64 conditioning=lowres dist=$DIST_NAME seed=$SEED"
echo "========================================"

case "$DIST_NAME" in
  uniform)
    python -u train.py --dataset eurosat64 --conditioning lowres --train_dist uniform --seed "$SEED"
    ;;
  logit_normal)
    python -u train.py \
        --dataset eurosat64 \
