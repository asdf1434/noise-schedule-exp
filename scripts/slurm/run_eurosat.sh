...
# ==========================================
# EuroSAT counterpart to run_exp1.sh: same train_dist x seed sweep (Q1 setup
# -- train_dist x sampling_schedule, conditioning=none), just pointed at
# --dataset eurosat instead of mnist. See src/utils.py's
# get_eurosat_dataloaders for how EuroSAT is reduced to MNIST's 28x28
# monochrome format (grayscale, resize 64->32, center-crop 28x28).
#
...
# sequentially in one long job.
# ==========================================
#SBATCH --job-name=eurosat_pilot
...
#SBATCH --array=0-9
#SBATCH --output=logs/slurm/slurm_eurosat_pilot_%A_%a.out
...
# ==========================================
# Map array task ID -> (train_dist, seed)
# ==========================================
...
echo "========================================"
echo "Array task $IDX: dataset=eurosat train_dist=$DIST seed=$SEED"
echo "========================================"
...
echo "Once ALL 10 array tasks finish, run evaluate_fid.py --dataset eurosat separately -- see"
