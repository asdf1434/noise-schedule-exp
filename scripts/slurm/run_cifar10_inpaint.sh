...
# ==========================================
# Q2 conditioning sweep: cifar10 with --conditioning inpaint, the same 6
...
# ==========================================
#SBATCH --job-name=cifar10_inpaint
...
#SBATCH --array=0-119
#SBATCH --output=logs/slurm/slurm_cifar10_inpaint_%A_%a.out
...
echo "========================================"
echo "Array task $IDX: dataset=cifar10 conditioning=inpaint dist=$DIST_NAME seed=$SEED"
echo "========================================"

case "$DIST_NAME" in
  uniform)
    python -u train.py --dataset cifar10 --conditioning inpaint --train_dist uniform --seed "$SEED"
    ;;
  logit_normal)
    python -u train.py \
        --dataset cifar10 \
