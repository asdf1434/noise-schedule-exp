...
# ==========================================
# Stage 1 of 3 -- scoring prep for the w=1 (x-prediction) run.
#
...
#SBATCH --output=logs/slurm/slurm_lw_eval_prep_%j.out

set -e
mkdir -p logs/slurm
source venv/bin/activate

# Keep in sync with run_lw_eval.sh.
