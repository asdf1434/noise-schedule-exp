...
# ==========================================
# Stage 2 of 3 -- score the w=1 (x-prediction) run.
#
...
#
# 3 datasets x 16 shards = 48 tasks. Includes plain mnist, which the shift eval Anything already present in
...
#
#   PREP=$(sbatch --parsable scripts/slurm/run_lw_eval_prep.sh)
...
#SBATCH --array=0-47
#SBATCH --output=logs/slurm/slurm_lw_eval_%A_%a.out
...
DATASETS=(mnist mnist_x10 cifar10_x10)
NUM_SHARDS=16
