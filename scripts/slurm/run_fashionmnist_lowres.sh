...
# ==========================================
# Q2 conditioning sweep: fashion_mnist with --conditioning lowres, the same 6
...
# ==========================================
#SBATCH --job-name=fashionmnist_lowres
...
echo "========================================"
echo "Array task $IDX: dataset=fashion_mnist conditioning=lowres dist=$DIST_NAME seed=$SEED"
echo "========================================"

case "$DIST_NAME" in
  uniform)
    python -u train.py --dataset fashion_mnist --conditioning lowres --train_dist uniform --seed "$SEED"
    ;;
  logit_normal)
    python -u train.py \
...
echo "cond-lowres runs alongside the cond-none ones already scored."
echo "========================================"
