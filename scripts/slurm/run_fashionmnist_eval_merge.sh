...
# ==========================================
# Step 3 of 3 -- merges the per-shard master_fid_results_shard*_fashion_mnist.json
# files (written by run_fashionmnist_eval_array.sh's 64 array tasks) into
...
#
# Run AFTER all 64 run_fashionmnist_eval_array.sh tasks have finished:
#   sbatch --dependency=afterok:<ARRAY_JOBID> scripts/slurm/run_fashionmnist_eval_merge.sh
# ==========================================
#SBATCH --job-name=fashionmnist_eval_merge
...
#SBATCH --output=logs/slurm/slurm_fashionmnist_eval_merge_%j.out
...
echo -e "\n========================================"
echo "Merge done. master_fid_results.json now also has 120 ds-fashion_mnist__ entries"
